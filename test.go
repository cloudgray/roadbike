...
func (s *ABstore) makeTrade(ctx contractapi.TransactionContextInterface, _sn string, _seller string) (Trade, error) {
...
func (s *ABstore) signTrade(ctx contractapi.TransactionContextInterface, _sn string, _buyer string) {

}

// Produce func
func (s *ABstore) producePart(ctx contractapi.TransactionContextInterface, partName string) error {
	var shimano Shimano
	shimanoBytes, err := ctx.GetStub().GetState("Shimano")
	if err != nil {
		return err
	}
	...
	case "transmission":
		...
		shimano.TrStock = append(shimano.TrStock, snStr)
	case "brake":
		...
		shimano.BrStock = append(shimano.BrStock, snStr)
	case "wheel":
		...
		shimano.WhStock = append(shimano.WhStock, snStr)
	}
...
// purchasePart func
func (s *ABstore) purchasePart(ctx contractapi.TransactionContextInterface, partName string) error {
...
func (s *ABstore) produceRoadbike(ctx contractapi.TransactionContextInterface) (string, error) {
...
func (s *ABstore) purchaseRoadbike(ctx contractapi.TransactionContextInterface) error {
	// specaialized state
	var specialized Specialized
	specializedBytes, _ := ctx.GetStub().GetState("Specialized")
	err := json.Unmarshal(specializedBytes, &specialized)
...
func (s *ABstore) getBikeList(ctx contractapi.TransactionContextInterface) ([]string, error) {
	// bikestore state
	var bikeStore BikeStore
...
func (s *ABstore) purchaseMyBike(ctx contractapi.TransactionContextInterface, _owner string, _sn string) error {
	timeNow := time.Now().Format("2020-01-01")
...
func (s *ABstore) changeOwner(ctx contractapi.TransactionContextInterface, _owner1 string, _owner2 string) error {
	// bike state
	var roadbike Roadbike
...
func (s *ABstore) getBikeInfo(ctx contractapi.TransactionContextInterface, _sn string) (Roadbike, error) {
	// bike state
	var roadbike Roadbike
	roadbikeBytes, _ := ctx.GetStub().GetState(_sn)
	err := json.Unmarshal(roadbikeBytes, &roadbike)
...
func (s *ABstore) getMyBikeInfo(ctx contractapi.TransactionContextInterface, _owner string) (Roadbike, error) {
	// bike state
	var roadbike Roadbike
...
func (s *ABstore) changePart(ctx contractapi.TransactionContextInterface, _owner string, _part string, _sn string) (Roadbike, error) {
	// bike state
	var roadbike Roadbike
	roadbikeBytes, _ := ctx.GetStub().GetState(_owner)
	err := json.Unmarshal(roadbikeBytes, &roadbike)
